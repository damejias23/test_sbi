...
func (a *UpdateEESubscriptionApiService) UpdateEeSubscriptionExecute(r ApiUpdateEeSubscriptionRequest) (*PatchResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{ueIdentity}/ee-subscriptions/{subscriptionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ueIdentity"+"}", url.PathEscape(parameterToString(r.ueIdentity, "")), -1)
