...
func (o *IdleStatusIndication) GetEdrxCycleLength() int32 {
	if o == nil || o.EdrxCycleLength == nil {
		var ret int32
		return ret
	}
...
func (o *IdleStatusIndication) GetSuggestedNumOfDlPackets() int32 {
	if o == nil || o.SuggestedNumOfDlPackets == nil {
		var ret int32
		return ret
	}
